...
from audit_ledger.notary import (
    NotaryClient,
    NotaryLedger,
    NotaryServer,
    _mac,
...
# Local stand-ins: HashChainedAudit.record() is duck-typed, so the ledger has no
# dependency on the upstream Action/Decision types — a tiny shim feeds it.
class Action:
    def __init__(self, actor="a", tool="t", action_purpose="p", data_labels=()):
        self.actor = actor
        self.tool = tool
        self.action_purpose = action_purpose
        self.data_labels = data_labels
        self.session_id = "default"


class Verdict:
    ALLOW = type("V", (), {"value": "allow"})()
